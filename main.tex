...
\label{sec:Intro}
Les \emph{réseaux génératifs adverses} connus en anglais sous le terme \href{https://en.wikipedia.org/wiki/Generative_adversarial_network}{Generatif Adversarial Networks} (GAN) sont des modèles qui permettent, par un apprentissage non supervisé, de générer des données cohérentes par rapport à un jeu de données.
