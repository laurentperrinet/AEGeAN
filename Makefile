...
debug:
	...
	KMP_DUPLICATE_LIB_OK=TRUE  python3 -c'import AEGEAN as AG; opt = AG.init(); opt.run_path = "AEGEAN_test"; opt.datapath="../database/cats/";  opt.n_epochs=5;  opt.padding_mode="zeros"; opt.img_size = 64; opt.verbose=True; AG.learn(opt)'
