...
def init():
    ...
    parser.add_argument("--valid_smooth", type=float, default=.95, help="Smoothing the results of D on real images")
    parser.add_argument("--dropout", type=float, default=.005, help="Dropout generalization factor in the encoder & generator")
    parser.add_argument("--E_noise", type=float, default=0.001, help="Add noise to the input images to G_E_x")
    parser.add_argument("--D_noise", type=float, default=0.0001, help="Add noise to the input images to D_x")
    parser.add_argument("--G_noise", type=float, default=0.0001, help="Add noise to the input images to D_G_z")
    ...
    parser.add_argument("--channel0", type=int, default=128, help="size of channel 0")
