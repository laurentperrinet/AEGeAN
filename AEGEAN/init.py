...
def init():
    ...
    parser.add_argument("--lrE", type=float, default=0.015*DEBUG, help="learning rate for E")
    ...
    parser.add_argument("--G_loss", type=str, default='ian', help="Use different losses for G.")
    ...
    parser.add_argument("--channel0", type=int, default=064//DEBUG, help="size of the channel 0")
