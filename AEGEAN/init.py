...
def init():
    ...
    parser.add_argument("--rand_affine", type=float, default=None, help="data augmentation: angle in degrees")
    parser.add_argument("--init_weight", type=bool, default=False, help="initialize weights to normal")
    parser.add_argument("--lrE", type=float, default=0.0001*DEBUG, help="learning rate for E")
    parser.add_argument("--lambdaE", type=float, default=0, help="regularization parameter for E")
    parser.add_argument("--lrD", type=float, default=0.00005*DEBUG, help="learning rate for D")
    ...
    parser.add_argument("--latent_dim", type=int, default=0, help="dimensionality of the latent space")
