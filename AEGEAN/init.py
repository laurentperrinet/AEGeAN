...
def init():
    ...
    parser.add_argument("--lrD", type=float, default=0.0004, help="learning rate for D")
    ...
    parser.add_argument("--G_noise", type=float, default=0., help="Add noise to the input images to D_G_z")
    ...
    parser.add_argument("--channel0_bg", type=int, default=4, help="size of the background mask channel")
