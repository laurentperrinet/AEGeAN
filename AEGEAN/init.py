...
def init():
    ...
    parser.add_argument("--lambdaE", type=float, default=.08, help="regularization parameter for E")
    ...
    parser.add_argument("--G_noise", type=float, default=0.008, help="Add noise to the input images to D_G_z")
