...
def init():
    ...
    parser.add_argument("--lambdaG", type=float, default=.0, help="regularization parameter for G")
    ...
    parser.add_argument("--lrG", type=float, default=0.0002, help="learning rate for G supervised by D")
