...
def init():
    ...
    parser.add_argument("--lrD", type=float, default=0.02, help="learning rate for D")
    parser.add_argument("--lrG", type=float, default=0.002, help="learning rate for G supervised by D")
