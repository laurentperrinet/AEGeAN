...
#     # Plot std scores
#     plot_std_cv(hist["D_x_std"], hist["D_G_z_std"], hist["D_x_cv"],
#                 hist["D_G_z_cv"], start_epoch, epoch)
#     # Plot min et max scores
#     plot_min_max(hist["D_x_max"], hist["D_G_z_max"], hist["D_x_min"],
#                  hist["D_G_z_min"], start_epoch, epoch)
